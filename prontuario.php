...
$cpfpaciente = $_SESSION['CPF_paciente']; //RECEBE POR SESSÃO O VALOR DO CPF DO ARQUIVO CONECTABANCO3
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="avaliacao.php">Voltar</a></li>
  ...
  <div class="container">
    ...
    <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Prontuário</h2>
    <!-- Icon Divider-->
  ...
  <form name="meu_form" method="POST" action="class/ConectaBanco3.php" style="text-align: center; display: flex; width: 100%; justify-content: center;">
      ...
      <div>
        ...
        <div class="control-group">
          <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
            <label>CPF</label>
            <input type="text" id="dataid" name="CPF_paciente" name="CPF_paciente[]" value="" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="CPF" />
        ...
        <div class="control-group">
          <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
            ...
            <input type="date" id="dataid" name="dataProc" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Data do Procedimento" />
            <p class="help-block text-danger"></p>
          </div>
        </div>
        ...
        <div class="control-group">
          <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
            ...
            <input type="text" id="ncadastro" name="nomeMedico" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Nome do Medico" />
            <p class="help-block text-danger"></p>
          </div>
        </div>
        ...
        <div class="control-group">
          <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
            ...
            <input type="text" id="nomeid" name="Procedimento" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Procedimento" />
            <p class="help-block text-danger"></p>
          </div>



          <table border="1" name="meu_form" style="text-align: center; width: 100%; justify-content: center;">
            <tr>
              <th>Data</th>
              <th>Procedimentos</th>
            ...
            $consulta = $pdo->query("SELECT DISTINCT
            prontuario.CPF_paciente,
            prontuario.data,
            prontuario.medico,
            prontuario.procedimento
            FROM prontuario
            WHERE CPF_paciente = '$cpfpaciente'"); //RECEBE POR SESSÃO O VALOR DO CPF DO ARQUIVO CONECTABANCO3 QUE ESTA NO TOPO DA TELA
              ...
              <tr>
                <td>
                  <div class="control-group">
                    <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
                      <p></p>
                      <input disabled value="<?php echo $linha['data']; ?>" type="text" id="nomeid" name="nome" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Nome" />
                      <p class="help-block text-danger"></p>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="control-group">
                    <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
                      <p></p>
                      <input disabled value="<?php echo $linha['procedimento']; ?>" type="text" id="nomeid" name="nome" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Nome" />
                      <p class="help-block text-danger"></p>
                    </div>
                  </div>
                </td>
                <td>
                  <div class="control-group">
                    <div class="form-group floating-label-form-group controls mb-0 pb-2" style="text-align: left;">
                      <p></p>
                      <input disabled value="<?php echo $linha['medico']; ?>" type="text" id="nomeid" name="nome" style="border-radius: 5px; padding-left: 10px;" class="form-control" required="required" placeholder="Nome" />
                      <p class="help-block text-danger"></p>
                    </div>
                  </div>
                </td>
